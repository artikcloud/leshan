...
public class LeshanTCPServerDemo {

    private static final Logger LOG = LoggerFactory.getLogger(LeshanTCPServerDemo.class);
    ...
    public static void createAndStartServer(int webPort, String localAddress, int localPort, String secureLocalAddress,
        ...
        LeshanTCPServer lwServer = builder.build();

        // Now prepare Jetty
        Server server = new Server(webPort);
        WebAppContext root = new WebAppContext();
        root.setContextPath("/");
        root.setResourceBase(LeshanTCPServerDemo.class.getClassLoader().getResource("webapp").toExternalForm());
