...
import org.eclipse.leshan.server.californium.LeshanTCPServerBuilder;
 ...
 * 
 */
public class IntegrationTCPTestHelper {
    ...
    public void createClient() {
        ...
        initializer.setInstancesForObject(
                LwM2mId.SECURITY,
                Security.tcp("coap+tcp://" + server.getUnsecuredAddress().getHostString() + ":" + server.getUnsecuredAddress().getPort(), 12345));
        initializer.setInstancesForObject(LwM2mId.SERVER, new Server(12345, LIFETIME, BindingMode.T, false));
        initializer.setInstancesForObject(LwM2mId.DEVICE, new Device("Eclipse Leshan", MODEL_NUMBER, "12345", "T") {
            @Override
        ...
        // Build Client
        LeshanTCPClientBuilder builder = new LeshanTCPClientBuilder(currentEndpointIdentifier.get());
