...
public class LeshanTCPServer implements LwM2mServer {
    ...
    public LeshanTCPServer(
            CoapEndpoint unsecuredEndpoint, CoapEndpoint securedEndpoint,
            CaliforniumRegistrationStore registrationStore, SecurityStore securityStore, Authorizer authorizer,
            LwM2mModelProvider modelProvider, LwM2mNodeEncoder encoder, LwM2mNodeDecoder decoder, NetworkConfig coapConfig,
    ...
    public void start() {
        ...
        if (LOG.isInfoEnabled()) {
            LOG.info("LWM2M TCP server started at {} {}",
    ...
    public void stop() {
        ...
        LOG.info("LWM2M TCP server stopped.");
    }
    ...
    public void destroy() {
        ...
        LOG.info("LWM2M TCP server destroyed.");
    }
