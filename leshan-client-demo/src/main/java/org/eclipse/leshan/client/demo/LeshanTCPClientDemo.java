...
public class LeshanTCPClientDemo {

    private static final Logger LOG = LoggerFactory.getLogger(LeshanTCPClientDemo.class);
    ...
    public static void main(final String[] args) {
        ...
        if (cl.hasOption("u")) {
            ...
            if (cl.hasOption("i"))
                serverURI = "coaps+tcp://localhost:" + LwM2m.DEFAULT_COAP_SECURE_PORT;
            else
    ...
    public static void createAndStartClient(String endpoint, String localAddress, int localPort,
        ...
        // Create client
        LeshanTCPClientBuilder builder = new LeshanTCPClientBuilder(endpoint);
